package com.xm.vexorbackend.langgraph4j.node;

import static org.bsc.langgraph4j.action.AsyncNodeAction.node_async;

import com.xm.vexorbackend.langgraph4j.ai.ImageCollectionPlanService;
import com.xm.vexorbackend.langgraph4j.model.ImageCollectionPlan;
import com.xm.vexorbackend.langgraph4j.model.ImageResource;
import com.xm.vexorbackend.langgraph4j.tools.ImageSearchTool;
import com.xm.vexorbackend.langgraph4j.tools.LogoGeneratorTool;
import com.xm.vexorbackend.langgraph4j.tools.MermaidDiagramTool;
import com.xm.vexorbackend.langgraph4j.tools.UndrawIllustrationTool;
import com.xm.vexorbackend.utils.SpringContextUtil;
            ...
            try {
                ...
                if (plan.getContentImageTasks() != null) {
                    ...
                    for (ImageCollectionPlan.ImageSearchTask task : plan.getContentImageTasks()) {
                        futures.add(
                                CompletableFuture.supplyAsync(() -> imageSearchTool.searchContentImages(task.query())));
                    }
                }
                // 并发执行插画图片搜索
                if (plan.getIllustrationTasks() != null) {
                    ...
                    for (ImageCollectionPlan.IllustrationTask task : plan.getIllustrationTasks()) {
                        futures.add(CompletableFuture
                                .supplyAsync(() -> illustrationTool.searchIllustrations(task.query())));
                    }
                }
                // 并发执行架构图生成
