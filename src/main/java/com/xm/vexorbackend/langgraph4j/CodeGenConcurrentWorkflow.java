...
import com.xm.vexorbackend.langgraph4j.node.*;
import com.xm.vexorbackend.langgraph4j.node.concurrent.*;
...
public class CodeGenConcurrentWorkflow {
    ...
    public CompiledGraph<MessagesState<String>> createWorkflow() {
        try {
            ...
            throw new BusinessException(ErrorCode.OPERATION_ERROR, "并发工作流创建失败", "并发工作流创建失败");
        }
    }
