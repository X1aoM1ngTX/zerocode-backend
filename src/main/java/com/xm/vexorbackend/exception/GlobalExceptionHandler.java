package com.xm.vexorbackend.exception;
...
public class GlobalExceptionHandler {
        ...
        if ((accept != null && accept.contains("text/event-stream")) ||
            ...
            try {
                ...
                if (response.isCommitted()) {
                    log.warn("SSE response already committed, cannot send error event. errorCode: {}, errorMessage: {}",
                ...
                // 处理 getOutputStream() 已被调用的情况
                log.error("SSE error handling failed due to response state: {}", illegalStateException.getMessage());
                return true;
            }
        }
        return false;
    ...
    public BaseResponse httpMessageNotWritableExceptionHandler(
    ...
    // public BaseResponse<?> notPermissionExceptionHandler(NotPermissionException
    // e) {
