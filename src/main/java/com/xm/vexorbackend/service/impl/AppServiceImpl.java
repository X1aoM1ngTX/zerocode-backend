...
import com.xm.vexorbackend.core.handler.StreamHandlerExecutor;
...
import com.xm.vexorbackend.mapper.AppMapper;
...
import com.xm.vexorbackend.model.enums.ChatHistoryMessageTypeEnum;
...
import com.xm.vexorbackend.service.ChatHistoryService;
import com.xm.vexorbackend.service.ScreenshotService;
...
public class AppServiceImpl extends ServiceImpl<AppMapper, App> implements AppService {
    ...
    public void generateAppScreenshotAsync(Long appId, String appUrl) {
        ...
        Thread.startVirtualThread(() -> {
            ...
            ThrowUtils.throwIf(!updated, ErrorCode.OPERATION_ERROR, "更新应用封面字段失败", "更新应用封面字段失败");
        });
    }
