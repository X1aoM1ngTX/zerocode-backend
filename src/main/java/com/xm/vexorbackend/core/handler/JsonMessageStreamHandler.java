package com.xm.vexorbackend.core.handler;

import cn.hutool.core.util.StrUtil;
import cn.hutool.json.JSONObject;
import cn.hutool.json.JSONUtil;

import com.xm.vexorbackend.ai.tools.BaseTool;
import com.xm.vexorbackend.ai.tools.ToolManager;
import jakarta.annotation.Resource;

import com.xm.vexorbackend.ai.model.message.*;
        ...
        return originFlux
                ...
                .doOnComplete(() -> {
                    ...
                    chatHistoryService.addChatMessage(appId, aiResponse, ChatHistoryMessageTypeEnum.AI.getValue(),
                            loginUser.getId());
                    // 异步构造 Vue 项目
                    // String projectPath = AppConstant.CODE_OUTPUT_ROOT_DIR + "/vue_project_" +
                    // appId;
