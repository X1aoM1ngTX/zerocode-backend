...
import com.xm.zerocodebackend.manager.CosManager;
import com.xm.zerocodebackend.service.ScreenshotService;
import com.xm.zerocodebackend.utils.WebScreenshotUtils;
...
public class ScreenshotServiceImpl implements ScreenshotService {
    ...
    /**
     * 生成截图的对象存储键
     * 格式：/zerocode/screenshots/2025/12/1/filename.jpg
     *
     * @param fileName 文件名
     */
    private String generateScreenshotKey(String fileName) {
        String datePath = LocalDate.now().format(DateTimeFormatter.ofPattern("yyyy/MM/dd"));
        return String.format("/zerocode/screenshots/%s/%s", datePath, fileName);
    }
